    ...
    render(){
        return(
            <div className="container-fluid homepage">
                <div className={this.state.showAlert ? 'alert alert-info alert-dismissible fade show' : 'goaway'} role="alert">
                    ...
                    <div className='row'>
                        ...
                        <div className='col-sm-6 about'>
                            ...
                            <p>
                                ...
                                Sousa Foudation "recognizing" community and adult concert bands of outstanding 
